...
class Employee(Base):
    ...
    emergency_contact_relation = Column(String(50), nullable=True, comment="联系人关系")
    emergency_contact_phone = Column(String(20), nullable=True, comment="联系人电话")
...
class SalaryCalculation(Base):
    ...
    entry_date = Column(Date, nullable=True)
    base_salary = Column(DECIMAL(10, 2), nullable=False)
    base_salary_prorated = Column(DECIMAL(10, 2), default=0, comment="折算后基本工资（月中调薪后）")
    performance_standard_prorated = Column(DECIMAL(10, 2), default=0, comment="折算后绩效奖金标准（月中调薪后）")
